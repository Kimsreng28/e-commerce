...
<script>
import Wallets from "@/assets/images/BgWallet/wallets.png";
import Wallets1 from "@/assets/images/BgWallet/wallets2.png";
...
import HandBagDetailView from "../wallets/WalletDetailView.vue";
export default {
  components: {
    LandingBar,
    ShowCaseComponent,
  ...
  name: "HandBagProductView",
  data() {
    return {
      backgrounds: [
        {
          bgSrcFirst: Wallets,
          bgSrcSecond: Wallets1,
        },
      ],
